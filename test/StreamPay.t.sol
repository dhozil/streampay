...
contract StreamPay {
    ...
    function createStream(
        ...
        uint256 rate = (deposit * 1e18) / duration;
        require(rate > 0, "StreamPay: rate rounds to zero");
        ...
        _initStream(streamId, msg.sender, recipient, deposit, rate, duration);
        _streams[streamId].description = description;
    ...
    function _initStream(
        ...
        s.stopTime      = block.timestamp + duration;
        s.withdrawn     = 0;
